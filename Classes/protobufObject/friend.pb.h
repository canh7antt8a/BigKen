...
// optional int32 friendStatus = 3;
inline bool BINRemoveFriendResponse::has_friendstatus() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void BINRemoveFriendResponse::set_has_friendstatus() {
  _has_bits_[0] |= 0x00000004u;
}
inline void BINRemoveFriendResponse::clear_has_friendstatus() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void BINRemoveFriendResponse::clear_friendstatus() {
  friendstatus_ = 0;
  clear_has_friendstatus();
}
inline ::google::protobuf::int32 BINRemoveFriendResponse::friendstatus() const {
  return friendstatus_;
}
inline void BINRemoveFriendResponse::set_friendstatus(::google::protobuf::int32 value) {
  set_has_friendstatus();
  friendstatus_ = value;
}
