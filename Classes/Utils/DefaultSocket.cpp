...
//	CCLog("connectSocket---hClientSocket:%d", hClientSocket);
   ...
   /*if (setsockopt(peerSocket, SOL_SOCKET, SO_LINGER, (char*)&optval, sizeof(optval)) < 0) {
        CCLOG("linger data timeout Error");
    }*/ 
    ...
    //if (setsockopt(peerSocket, SOL_SOCKET, SO_LINGER, (char*)&timeout, sizeof(timeout)) < 0) {
    //    CCLOG("linger data timeout Error");
    //}
